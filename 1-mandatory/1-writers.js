...
function logDeadWritersInTheirForties() {
 ...
 const deadWritersInForties = writers.filter(
  (writer)=> !writer.alive && writer.age >= 40 && writer.age <= 49);
 deadWritersInForties.forEach((writer)=>
...
function logAliveWritersInTheirForties() {
  // write your code here
  const aliveWritersInForties = writers.filter(
  (writer)=> writer.alive && writer.age >= 40 && writer.age <= 49);
 aliveWritersInForties.forEach((writer)=>
