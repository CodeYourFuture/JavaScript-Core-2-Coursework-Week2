...
let bottle = {
  ...
  fillUp: function () {
    ...
    return this.volume += unit * 10;
  },
  pour: function () {
    // calling this function should increase your bottle volume by 10 units;
    return this.volume >= 100 ? 100 : this.volume += unit;
  },
  drink: function () {
    // calling this function should decrease your bottle volume by 10 units;
    return this.volume <= 0 ? 0 : this.volume -= unit;
  },
  isFull: function () {
...
// It is preferred to use the "this" key word inside the object because it references the object method it is used in and it makes your code more dynamic and easier to maintain.
