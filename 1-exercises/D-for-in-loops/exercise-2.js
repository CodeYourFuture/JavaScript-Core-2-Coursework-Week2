...
let shapes = {  triangle: 3,  square: 4,  pentagon: 5,  triacontagon: 30,  hecatontagon: 100,
    megagon: 1000000,
};

let shapesWithMoreThanFiveSides = [];
for(let eachShape in shapes){
  if (shapes[eachShape] >= 5){
    shapesWithMoreThanFiveSides.push(eachShape)
  }
  }
