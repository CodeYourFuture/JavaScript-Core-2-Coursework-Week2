...
friends.forEach((friend) => {
const stacyColleageMyFriend = friends.colleague;
const firstName = friends.firstName;
const lastName = friends.lastName;

if(stacyColleageMyFriend === 'Stacie Villarreal') {
  friendsWhoAreColleaguesOfStacie.push(firstName + lastName)
