...
function logAllWriters() {
  writers.forEach((writerObject) => {
    console.log(
      `Hi, my name is ${writerObject.firstName} ${writerObject.lastName}. I am ${writerObject.age} years old, and work as a ${writerObject.occupation}.`
    );
  });
}
...
function logDeadWritersInTheirForties() {
  writers.forEach((writerObject) => {
    if (
      writerObject.alive === false &&
      writerObject.age <= 49 &&
      writerObject.age >= 40
    ) {
      console.log(
        `Writer ${writerObject.firstName} ${writerObject.lastName} died at ${writerObject.age} years old.`
      );
    }
  });
}
...
function logAliveWritersInTheirForties() {
  writers.forEach((writerObject) => {
    if (
      writerObject.alive === true &&
      writerObject.age >= 40 &&
      writerObject.age <= 49
    ) {
      console.log(
        `Hi, my name is ${writerObject.firstName} ${writerObject.lastName}. I am ${writerObject.age} years old.`
      );
    }
  });
}
