...
let bottle = {
  ...
  pour: function () {
    (this.volume + 10) <= 100 ? this.volume += 10 : this.volume = 100;
  },
  drink: function () {
    (this.volume - 10) >= 0 ? this.volume -= 10 : this.volume = 0;
  },
  isFull: function () {
...
// If we use `this`, we will send only one property to the method 
// but if we send its variable name which is an object, we will send all properties that it can be too many.
