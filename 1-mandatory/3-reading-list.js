...
function logBooks() {
  books.forEach((book) => {
    ...
    console.log(`You need to finish ${book.title} by ${book.author}`);
...
test("books are logged", function () {
  expectLogBooksToLog([
    ...
    "You need to finish Dietland by Sarai Walker",
    "You need to finish A Place for Us by Fatima Farheen Mirza",
    "You need to finish The House of Impossible Beauties by Joseph Cassara",
  ]);
});
