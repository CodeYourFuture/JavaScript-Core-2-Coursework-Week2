...
const books = [
  ...
  {
    theTitle: "The Silmarillion",
    author: "J.R.R. Tolkien",
    alreadyRead: false,
  },
  {
    theTitle: "The Paris Notebook",
    author: "Tessa Harris",
    alreadyRead: false,
  },
  {
    theTitle: "Lifesaving for Beginners",
    author: "Josie Lloyd",
    alreadyRead: false,
  },
  {
    theTitle: "Other Parents",
...
function logBooks() {
  for (element of books) {
    console.log (`${element.theTitle} by ${element.author}`)
  }
}
