...
// friends.map((friend) => {
//   if (friend.age >= 35) thirtyFiveOrOlder.push(friend.name);
// });
...
// friends.map((friend) => {
//   friend.colleagues.map((colleague) => {
...
// //     if (colleague.skills.includes("Multi-tasking") === true)
...
//   const locationsByMYTransportMode = [];
//   for (location in locations) {
//     let arrayTransport = locations[location];
//     if (locations[location].includes(transportMode) === true)
//       locationsByMYTransportMode.push(location);
//   }
//   return locationsByMYTransportMode;
// }
...
// };
// console.log(journeyPlanner(locations, "bus"));

function chooseMeal(mealArray) {
  let selectedMeal = 0;
  if (mealArray.length === 0) selectedMeal = null;
  else if (mealArray.length === 1) selectedMeal = mealArray[0].price;
  else {
