...
// exercise 1
function logBooks(name) {
  books.push({ title: name });
}

logBooks("The Hobbit by J.R.R. Tolkien");
logBooks("The Testament by Shevchenko");
logBooks("Three Comrades by Erich Maria Remarque");
logBooks(
  "How To Be A Stoic: Ancient Wisdom for Modern Living by Massimo Pigliucci"
);
logBooks("Man's Search for Meaning by Viktor Frankl");
console.log(books);
/*
=====
Exercise 2
