...
const books = [
  { title: "So Long a Letter", author: "Mariama Ba", alreadyRead: true },
  { title: "A Man of the people", author: "Chinua Achebe", alreadyRead: true },
  { title: "His Only Wife", author: "Peace Adzo Medie", alreadyRead: false },
  { title: "Madame Bovary", author: "Gustave Flaubert", alreadyRead: true },
  { title: "Disgrace", author: "J.M. Coetzee", alreadyRead: false },
];
...
test("books are logged", function () {
  expectLogBooksToLog([
    'You\'ve already read "So Long a Letter" by Mariama Ba',
    'You\'ve already read "A Man of the people" by Chinua Achebe',
    'You still need to read "His Only Wife" by Peace Adzo Medie',
    'You\'ve already read "Madame Bovary" by Gustave Flaubert',
    'You still need to read "Disgrace" by J.M. Coetzee',
  ]);
});
