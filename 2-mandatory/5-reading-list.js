...
//    "The Office by Charles Bukowski",
...
test("books are logged", function () {
  expectLogBooksToLog([
    "You have already read Ince Mehmet by Yasar Kemal",
    "You have already read The Office by Charles Bukowski",
    "You have already read The Old Man and the Sea by Ernest Hemingway",
    "You have already read The Metamorphosis by Franz Kafka",
    "You have already read Crime and Punishment by Fyodor Dostoevsky",
  ]);
});
