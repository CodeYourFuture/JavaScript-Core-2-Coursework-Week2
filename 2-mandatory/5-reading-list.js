...
const books = [
  ...
  { title: "The Brain", author: "David Eagleman", alreadyRead: false },
...
test("books are logged", function () {
  expectLogBooksToLog([
    ...
    "You've already read The Power of your subconscious mind by Joseph Murphy",
    "You still need to read The Brain by David Eagleman",
