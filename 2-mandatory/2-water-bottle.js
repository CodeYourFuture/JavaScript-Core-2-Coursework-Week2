...
let bottle = {
  ...
  fillUp: function () {
     bottle.volume = 100;
     return bottle.volume     // calling this function should completely fill your bottle (volume = 100);
  },
  pour: function () {
    if(bottle.volume<=90){
      return bottle.volume+=10
    }else return bottle.volume = 100
    // calling this function should increase your bottle volume by 10 units;
  },
  drink: function () {
    if(bottle.volume>=10){
      return bottle.volume-=10
    }else return bottle.volume = 0 // calling this function should decrease your bottle volume by 10 units;
  },
  isFull: function () {
    if(this.volume === 100){
      return true
    }else return false // this function should return true if your bottle is full;
  },
  isEmpty: function () {
    if(this.volume === 0){
      return true
    } else return false// this function should return true if your bottle is empty;
  },
};
