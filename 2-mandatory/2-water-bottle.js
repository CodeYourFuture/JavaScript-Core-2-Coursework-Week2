...
// because then it can apply to different instances of objects and even if the variable name changes, that is another object is created referencing the same variable it will still apply to same object regardless of changing name. 
/*
