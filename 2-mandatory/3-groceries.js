...
for (day in weeklyMealPlan) {
  weeklyMealPlan[day].forEach((e) => {
    if (!weeklyGroceriesToBuy.includes(e)) weeklyGroceriesToBuy.push(e);
  });
}
...
for (day in weeklyMealPlan) {
  if (day === ("saturday" || "sunday")) {
    weeklyMealPlan[day].forEach((e) => {
      if (!weekendGroceriesToBuy.includes(e)) weekendGroceriesToBuy.push(e);
    });
  }
}
