...
function chooseMeal(mealArray) {
  ...
  console.log(mealArray[0].name);
  let cheapestMeal = Math.min(mealArray.forEach(x => x.price));
  console.log(cheapestMeal)
  if (mealArray === []) { // By absent-mindedness I had this as if (mealArray = []) and it was always returning "Nothing :("
    return "Nothing :(";
...
// console.log(chooseMeal([]))
console.log(chooseMeal([{ name: "Lobster", price: 10.99 }]))
