...
const books = [
  ...
  {
    title: "In attesa della la prossima estate",
    author: "Tormod Haugen",
    alreadyReady: true,
  },
  {
    title: "Fekir eske mekabr",
...
// exercise 1
function logBooks() {
  books.forEach((writer) => console.log(`${writer.title} by ${writer.author}`));
}
...
test("books are logged", function () {
  expectLogBooksToLog([
    "Yetekolefebt kulf by Dr Mehret Debebe",
    "Lelasew by Dr Mehret Debebe",
    "The Arabian Nights by Tahir Shah",
    "In attesa della la prossima estate by Tormod Haugen",
    "Fekir eske mekabr by Hadis Alemayehu",
  ]);
});
