...
test("Meal to select is last", function () {
  expect(chooseMeal([{
    name: "Dunkin' Donuts",
    price: 8.99
  }, {
...
test("Meal to select is first", function () {
  expect(chooseMeal([{
    name: "Moe's Southwest Grill",
    price: 10.99
  }, {
...
test("Meal to select is also most expensive", function () {
  expect(chooseMeal([{
    name: "Burger King",
    price: 8.99
  }, {
...
test("Only one meal to select", function () {
  expect(chooseMeal([{
    name: "Subway",
    price: 8.99
  }])).toEqual("Subway");
});
test("No meals to select", function () {
  expect(chooseMeal([])).toEqual("Nothing :(");
});
test("Meal to select is second cheapest, not second most expensive", function () {
  expect(chooseMeal([{
