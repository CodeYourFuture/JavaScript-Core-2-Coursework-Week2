...
let bottle = {
  volume: 0,
  fillUp: function () {this.volume = (100 - this.volume) + this.volume
    // calling this function should completely fill your bottle (volume = 100);
  },
  pour: function () {if(this.volume <= 90) {this.volume += 10}
    // calling this function should increase your bottle volume by 10 units;
  },
  drink: function () {if(this.volume >= 10) {this.volume -= 10}
    // calling this function should decrease your bottle volume by 10 units;
  },
  isFull: function () {return this.volume === 100 ? true : false
    // this function should return true if your bottle is full;
},
  isEmpty: function () {return this.volume === 0 ? true : false
