...
let arraysOfGroceries = Object.values(weeklyMealPlan);

for (let arr of arraysOfGroceries) {
  for (let item of arr) {
...
weekendGroceriesToBuy = weeklyMealPlan.saturday;
...
for (let count in numberOfItemsPerWeek) {
