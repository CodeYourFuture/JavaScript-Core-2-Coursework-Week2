...
let logBooks = () =>
  books.forEach((book) => {
    if (book.alreadyRead == true) {
      ...
      console.log(
        `You'll still need to read "${book.title}" by ${book.author}`
      );
    }
  });
...
test("books are logged", function () {
  expectLogBooksToLog([
    'You\'ll still need to read "The Hobbit" by J.R.R. Tolkien',
    'You\'ll still need to read "The Map of Salt and Stars" by Jennifer Zeynab Joukhadar',
    'You\'ve already read "Dietland" by Sarai Walker',
    'You\'ll still need to read "A Place for Us" by Fatima Farheen Mirza',
