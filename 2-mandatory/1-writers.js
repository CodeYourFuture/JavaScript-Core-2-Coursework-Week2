...
*/
  ...
  return writers.filter((writer => writer.age >= 40 && writer.age < 50 && !writer.alive )).forEach((writer) => console.log(`Writer ${writer.firstName} ${writer.lastName} died at ${writer.age} years old.`))
