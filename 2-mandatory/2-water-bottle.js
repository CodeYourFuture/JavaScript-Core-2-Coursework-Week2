...
let bottle = {
  ...
  pour: function () {
    ...
    return this.volume === 100 ? this.volume = this.volume : this.volume = this.volume + 10;
  },
  drink: function () {
    // calling this function should decrease your bottle volume by 10 units;
    return this.volume === 0 ? this.volume = this.volume : this.volume = this.volume - 10;
  },
  isFull: function () {
...
// We can re-use the functions in different execution contexts
