...
let bottle = {
  ...
  fillUp: function () {
    ...
    const spaceToFill = 100 - this.volume;
    this.volume < 100? this.volume += spaceToFill : this.isFull()
    
  },
  pour: function () {
    // calling this function should increase your bottle volume by 10 units;
    this.volume <= 90? this.volume += 10 : this.isFull()
  },
  drink: function () {
    // calling this function should decrease your bottle volume by 10 units;
    this.volume >=10? this.volume -= 10 : this.isEmpty()
  },
  isFull: function () {
