...
let bottle = {
  ...
  pour: function () {
    if (!this.isFull()) this.volume += 10;
  },
  drink: function () {
    if (!this.isEmpty()) this.volume -= 10;
  },
  isFull: function () {
...
// you may at some point change the name of the variable `bottle`. By using `this`
// the code can still run even with the changed name
/*
