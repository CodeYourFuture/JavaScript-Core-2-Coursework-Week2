...
function chooseMeal(mealArray) {  mealArray.sort((elementOne, elementTwo) => elementOne.price - elementTwo.price);
  return mealArray.length === 0 ? "Nothing :(" : mealArray.length === 1 ? mealArray[0].name : mealArray[1].name;
}
