...
let thirtyFiveOrOlder = friends.filter(object => object.age > 35);
...
let powerNetEmails = friends.filter(object => object.company === "POWERNET").map(item => item.email);
...
friends.forEach(object => object.colleagues.forEach(array => array.skills.includes("Multi-tasking") ? colleaguesWhoCanMultitask.push(array.name) : null));
