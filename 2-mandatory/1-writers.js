...
function logAllWriters() {
  // input and output
  //TODO access fst name , last names, age and occupation of all the writers.
  //TODO print out `"Hi, my name is {firstName} {lastName}. I am {age} years old, and work as a {occupation}.`
...
function logDeadWritersInTheirForties() {
  //TODO find writers wgo are in their 40s and dies  ( for condition we could filter, sort)
  //what age they have died - output format "Writer {firstName} {lastName} died at {age} years old."
  return writers
