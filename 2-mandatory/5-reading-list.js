...
//   expectLogBooksToLog([
//     "The Book No 1 by Author No 1",
//     "The Book No 2 by Author No 2",
//     "The Book No 3 by Author No 3",
//     "The Book No 4 by Author No 4",
//     "The Book No 5 by Author No 5",
//   ]);
// });

test("books are logged and checked if has been read or not", function () {
  expectLogBooksToLog([
    "You still need to read The Book No 1 by Author No 1",
    "You've already read The Book No 2 by Author No 2",
    "You've already read The Book No 3 by Author No 3",
    "You still need to read The Book No 4 by Author No 4",
    "You still need to read The Book No 5 by Author No 5",
  ]);
});
/* ======= TESTS - DO NOT MODIFY ===== */
/*
