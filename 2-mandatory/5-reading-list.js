...
const book = (title, author, alreadyRead) => {
  return {
    title,
    author,
    alreadyRead,
...
const books = [
  ...book("The power", "Mo", true),
  ...book("Javascript for dummies", "Ku", false),
  ...book("7 habits of highly effective programmer", "Rob", true),
  ...book("programmers bible", "kate", false),
  ...book("Azure for non Azure", "Rob", true),
];
...
test("books are logged", function () {
  expectLogBooksToLog([
    ...
    "7 habits of highly effective programmer",
    "programmers bible",
    "Azure for non Azure",
  ]);
});
