...
function chooseMeal(meals) {
  let sortedMeals = meals.sort((a, b) => a.price - b.price);
  if (meals.length === 0) return "Nothing :(";
  else if (meals.length === 1) return meals[0].name;
  else return sortedMeals[1].name;
}
