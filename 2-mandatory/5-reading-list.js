...
test("books are logged", function () {
 expectLogBooksToLog([
   "You\'ve already read Cover Her Face by P.D. James",
   "You still need to read The Daffodil Sky by H.E. Bates ",
   "You still need to read Conversations with Myself by Nelson Mandela",
   "You\'ve already read Dying of The Light by George R.R. Martin ",
   "You\'ve already read Except the Lord by Joyce Cary ",
 ]);
});
