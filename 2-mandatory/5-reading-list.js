...
test("books are logged", function () {
  expectLogBooksToLog([
    ...
    "The Kite Runner by Khalid Husseni",
...
test("check Books", function () {
  expectLogBooksToLogCheck([
    "You've already read Becoming by Michael Obama",
    "You still need to read The Kite Runner by Khalid Husseni",
    "You've already read The Alchemist by Paulo Coelho",
    "You still need to read The Lord of the Rings by J.R.R.Tolkien",
    "You've already read Elon Musk by Ashlee Vance",
  ]);
});
/* ======= TESTS - DO NOT MODIFY ===== */
/*
