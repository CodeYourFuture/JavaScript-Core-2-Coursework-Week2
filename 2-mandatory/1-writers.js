...
*/
  ...
  let  deadWritersInTheirForties = writers.filter((writer) => writer.age >= 40 && writer.age <= 49 && writer.alive === false);
   
  for (let writer of deadWritersInTheirForties) {
  console.log(
...
let aliveWritersInTheirForties = writers.filter((writer) => writer.age >= 40 && writer.age <= 49 && writer.alive === true);

for (let writer of aliveWritersInTheirForties) {
console.log(
