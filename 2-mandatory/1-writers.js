...
let logAllWriters2 = function (string2, arr) {
  let str = string2;
  let arrTest = arr.map((el) => {
    let result = str.replace(/firstName|lastName|age/gi, function (matched) {
      return el[matched];
    });
    console.log(result);
    return result;
...
function logAllWriters() {
  let string = `Hi, my name is firstName lastName. I am age years old, and work as a occupation.`;
  return logAllWriters2(string, writers);
}
...
function logDeadWritersInTheirForties() {
  ...
  let filtWrit = writers.filter(
    (el) => el["age"] >= 40 && el["age"] <= 49 && el["alive"] === false
  );

  let string = `Writer firstName lastName died at age years old.`;
  return logAllWriters2(string, filtWrit);
}
...
function logAliveWritersInTheirForties() {
  // write your code here
  let filtWrit = writers.filter(
    (el) => el["age"] >= 40 && el["age"] <= 49 && el["alive"] === true
  );

  let string = `Hi, my name is firstName lastName. I am age years old.`;
  return logAllWriters2(string, filtWrit);
}
