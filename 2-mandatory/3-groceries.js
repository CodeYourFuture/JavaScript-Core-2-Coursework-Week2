...
Object.values(weeklyMealPlan).flat().forEach((item) => {
  weeklyGroceriesToBuy.includes(item) ? null : weeklyGroceriesToBuy.push(item)})
...
weeklyMealPlan.saturday.concat(weeklyMealPlan.sunday);
