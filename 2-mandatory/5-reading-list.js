...
test("books are logged", function () {
  expectLogBooksToLog([
    "You've already read The Secret History by Donna Tartt",
    "You've already read Animal Farm by Robert Colls",
    "You've already read Frankenstein by Mary Shelley",
    "You still need to read Lolita by Vladimir Nabokov",
    "You still need to read Rebecca by Daphne du Maurier",
  ]);
});
