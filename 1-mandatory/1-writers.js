/* 
  ...
  different ways of looping through Arrays, it won't be different in this case. The only extra step is that 
  you have to 
...
function logDeadWritersInTheirForties() {
  let deadWriter = writers.filter(
    (writer) => !writer.alive && writer.age >= 40 && writer.age <= 49
  );
