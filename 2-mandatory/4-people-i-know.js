...
let friendsFilter = friends.filter(function(e){
  if(e.age >= 35){
    thirtyFiveOrOlder.push(e)
  }
})
...
let powerNetEmails = [];
let friendsEmail = friends.filter(function(e){
  if(e.company === "POWERNET"){
    return powerNetEmails.push(e.email)
  }
})
...
let friendsWho = friends.filter(function(person){
  person.colleagues.find(function(e){
    if(e.name === "Stacie Villarreal"){
