...
function logAliveWritersInTheirForties() {
  // write your code here
    return writers.filter((writer) => writer.age >= 40 && writer.age <= 49 && writer.alive)
    .map((writer) =>console.log(`Hi, my name is ${writer.firstName} ${writer.lastName}. I am ${writer.age} years old.`
      )
    );
}
/* ======= TESTS - DO NOT MODIFY ===== 
