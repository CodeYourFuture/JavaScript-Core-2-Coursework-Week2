...
//     console.log(`The ${eachBook.title} by ${eachBook.Author}`)
//   }
// }
...
//  expectLogBooksToLog([
//         "The Book number 1 by Author number 1",
//         "The Book number 2 by Author number 2",
//         "The Book number 3 by Author number 3",
//         "The Book number 4 by Author number 4",
//         "The Book number 5 by Author number 5"
//     ]);
// });
  
  
  
  test("books are logged and checked if has been read or not", function () {
    expectLogBooksToLog([
      "You still need to read The Book number 1 by Author number 1",
      "You've already read The Book number 2 by Author number 2",
      "You've already read The Book number 3 by Author number 3",
      "You still need to read The Book number 4 by Author number 4",
      "You still need to read The Book number 5 by Author number 5",
