...
for (let ingre in weeklyMealPlan) {
  if (["saturday", "sunday"].includes(ingre)) {
    weekendGroceriesToBuy.push(...weeklyMealPlan[ingre]);
  }
}
...
for (const ingredients in weeklyMealPlan) {
