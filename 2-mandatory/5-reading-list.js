...
test("books are logged", function () {
  expectLogBooksToLog([
    "Nyana Wam! Nyana Wam! by Witness K. Tamsanqa",
    "Buzani kuBawo by Witness K. Tamsanqa",
...
test("books are logged, stating if read or not", function () {
  expectReadBooksToLog([
    "You've already read Nyana Wam! Nyana Wam! by Witness K. Tamsanqa.",
    "You've already read Buzani kuBawo by Witness K. Tamsanqa.",
